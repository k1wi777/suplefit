  ...
  return (
    <AuthenticatedOnly>
      <main className="flex-1 min-h-screen bg-[#0a0a0a] relative overflow-hidden flex flex-col">
        ...
        {/* MAIN CONTENT */}
        <div className="flex-1 w-full min-w-0 h-screen overflow-y-auto custom-scrollbar relative z-10 px-4 md:px-12 lg:px-16 py-10 md:py-16 scroll-smooth">
           <div className="max-w-5xl mx-auto w-full min-w-0 flex flex-col gap-8 md:gap-12 animate-fade-in-up">
              ...
              <GlassCard className="min-w-0 rounded-[2.5rem] border-white/5 bg-[#070a09]/95 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.5)] relative flex flex-col items-center gap-6 overflow-hidden sm:p-8 md:flex-row md:gap-8 md:p-10">
                 ...
                 <div className="h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 rounded-full border border-white/10 bg-black relative flex items-center justify-center shrink-0 shadow-[0_0_30px_rgba(0,0,0,0.5)] overflow-hidden p-1">
                 ...
                 <div className="w-full min-w-0 flex-1 text-center md:text-left z-10">
                    <h1 className="text-white font-black text-3xl sm:text-4xl md:text-5xl tracking-tight mb-4 break-words [overflow-wrap:anywhere]">{profile?.nombre}</h1>
                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-6">
                       <span className="max-w-full px-3 py-1 rounded bg-[#baff2e]/20 text-[#baff2e] border border-[#baff2e]/30 text-[10px] font-black uppercase tracking-widest break-words">
                         {profile?.objetivo ? profile.objetivo.replace(/_/g, ' ') : 'Atleta Élite'}
                       </span>
                       <span className="max-w-full px-3 py-1 rounded bg-white/5 text-white/50 border border-white/10 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 break-words">
                    ...
                    <p className="text-white/60 text-sm md:text-base leading-relaxed max-w-xl break-words [overflow-wrap:anywhere]">
              ...
              <GlassCard className="min-w-0 rounded-[2.5rem] border-white/5 bg-[#070a09]/95 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.5)] sm:p-8 md:p-10">
                 <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-8">
                    <div className="min-w-0">
                      ...
                      <p className="text-white/50 text-xs break-words">Análisis comparativo de masa muscular vs. índice de grasa corporal.</p>
                    </div>
                    <div className="shrink-0 px-3 py-1.5 rounded-lg border border-white/10 bg-white/5 text-white/70 text-[10px] font-bold uppercase tracking-wider">
                      Mes
                    </div>
                 </div>
              ...
              <div className="grid min-w-0 grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                 ...
                 <GlassCard className="min-w-0 rounded-[2.5rem] border-white/5 bg-[#070a09]/95 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.5)] flex flex-col sm:p-8">
                    ...
                    <form onSubmit={handleCalibrationSave} className="flex-1 flex flex-col">
                      <div className="grid min-w-0 grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="grid min-w-0 grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <label className="flex flex-col gap-2">
                      ...
                      <div className="grid min-w-0 grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="flex flex-col gap-2 justify-end">
                          ...
                          <div className="w-full min-w-0 bg-[#151515] border border-[#baff2e]/20 rounded-xl px-4 py-3 text-[#baff2e] text-sm font-bold break-words">
                 ...
                 <GlassCard className="min-w-0 rounded-[2.5rem] border-white/5 bg-[#070a09]/95 p-5 shadow-[0_24px_70px_rgba(0,0,0,0.5)] flex flex-col sm:p-8">
                    <div className="flex min-w-0 items-center gap-3 mb-8">
                      ...
                      <h2 className="min-w-0 text-white font-bold text-xl sm:text-2xl break-words">Acceso y Seguridad</h2>
                    </div>
                    ...
                    <div className="border-t border-white/5 pt-6 mt-auto">
                      <div className="text-white/60 font-bold text-sm mb-4 break-words">Actualizar Contraseña</div>
                      ...
                      <form onSubmit={handlePasswordSave} className="flex min-w-0 flex-col sm:flex-row gap-3">
                         <input
                           type="password"
                           placeholder="Ingresa nueva contraseña..."
                           className="w-full min-w-0 flex-1 bg-[#1a1a1a] border border-white/5 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-white/20 transition-colors"
                           value={formPassword}
                           onChange={(e) => setFormPassword(e.target.value)}
                         />
                         <button disabled={savingPw || !formPassword.trim()} className="w-full sm:w-auto shrink-0 justify-center bg-white/10 hover:bg-white/20 disabled:opacity-50 text-white px-5 py-3 rounded-xl font-bold text-xs uppercase tracking-widest transition-colors flex items-center gap-2 whitespace-nowrap">
                           {savingPw ? "..." : "Actualizar"}
                         </button>
                      </form>
                        ...
                        <tr key={idx} className="group">
                          <td className="py-6">
                            <div className="flex min-w-0 items-center gap-4">
                              ...
                              <div className="min-w-0">
                                <Link href={`/supplements/${item.id}`} className="text-white font-bold group-hover:text-[#baff2e] transition-colors text-sm md:text-base break-words [overflow-wrap:anywhere]">
                                  {item.nombre}
                                </Link>
                                <div className="text-white/40 text-[10px] mt-1 line-clamp-1 max-w-sm break-words [overflow-wrap:anywhere]">{item.descripcion}</div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="py-6 text-right">
                             ...
                             <div className="text-white/40 text-[9px] font-black uppercase tracking-widest mt-2 break-words [overflow-wrap:anywhere]">{item.objetivo.replace(/_/g, ' ')}</div>
                          </td>
                        </tr>
                      ))}
                    </tbody>
